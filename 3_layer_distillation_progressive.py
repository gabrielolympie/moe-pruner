...
# python 3_layer_distillation_progressive.py --device cuda:1 --model_name deepseek_coder_v2_lite_instruct_awq --start_layer 22 --end_layer 27 --calibrate_merge 1 --n_epochs 2 --target_routed_expert 8 --target_active_expert 4
