...
# python 4.layer_distillation.py --device cuda:0 --n_routed_experts 8 --n_active_experts 4 --min_layer 56 --max_layer 58
# python 4.layer_distillation.py --device cuda:1 --n_routed_experts 8 --n_active_experts 4 --min_layer 61 --max_layer 62
...
if __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate", type=float, default=7e-4, help="Learning rate.")
    parser.add_argument(
        "--end_factor",
        type=float,
        default=0.001,
    ...
    for layer_idx in range(min_layer, max_layer):
        ...
        trainer = pl.Trainer(
            ...
            callbacks=[
                checkpoint_callback,
                early_stop_callback,
                # OptimizerModeCallback() ## keep only if schedule free
            ],
